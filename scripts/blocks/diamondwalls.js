...
diamondWallShard.width = 3;
diamondWallShard.height = 8;
diamondWallShard.shrinkY = 0.3;
diamondWallShard.shrinkX = 0.5;
diamondWallShard.speed = 4;
...
diamondWall.buildType = () => extendContent(Wall.WallBuild, diamondWall, {
	...
	onDestroyed(){
        ...
        for(var i = 0; i < 8; i++){
            ...
            Calls.createBullet(diamondWallShard, this.team, this.x, this.y, shardAngle, Mathf.random(0.5, 1.0), 1);
		}
	},
});
...
diamondWallLarge.buildType = () => extendContent(Wall.WallBuild, diamondWallLarge, {
	...
	onDestroyed(){
        ...
        for(var i = 0; i < 12; i++){
			var shardAngle = Mathf.random(360);
			diamondWallSharded.at(this.x, this.y, shardAngle);
            Calls.createBullet(diamondWallShard, this.team, this.x, this.y, shardAngle, Mathf.random(0.5, 1.5), 1);
		}
	},
});
...
diamondWallHuge.buildType = () => extendContent(Wall.WallBuild, diamondWallHuge, {
	...
	onDestroyed(){
        ...
        for(var i = 0; i < 16; i++){
			var shardAngle = Mathf.random(360);
			diamondWallSharded.at(this.x, this.y, shardAngle);
            Calls.createBullet(diamondWallShard, this.team, this.x, this.y, shardAngle, Mathf.random(0.5, 2.0), 1);
		}
	},
});
...
diamondWallGigantic.buildType = () => extendContent(Wall.WallBuild, diamondWallGigantic, {
	...
	onDestroyed(){
        ...
        for(var i = 0; i < 20; i++){
			var shardAngle = Mathf.random(360);
			diamondWallSharded.at(this.x, this.y, shardAngle);
            Calls.createBullet(diamondWallShard, this.team, this.x, this.y, shardAngle, Mathf.random(0.5, 2.5), 1);
		}
	},
});