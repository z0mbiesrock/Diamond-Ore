const devastatorBase = prov(() => extend(HoverUnit, {
	drawEngine(){
	...
	getPowerCellRegion(){
        return Core.atlas.find("diamond-ore-ancient-devastator-cell");
    },
}));
const ancientDevastator = extendContent(UnitType, "ancient-assembler", {
	load(){
		this.weapon.load();
...
ancientDevastator.create(devastatorBase);